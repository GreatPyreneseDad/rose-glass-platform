"""
Rose Glass Platform - Serverless-compatible server
Simplified version without lifespan for Vercel deployment
"""
...
# Note: Database functionality disabled for serverless  compatibility
# Conversations will not be persisted in serverless mode
...
app = FastAPI(
    ...
    description="LLM proxy with perception and calibration - v2.1 with cultural lenses (Serverless)",
...
async def chat_completions(
    ...
    # Note: Database logging disabled in serverless mode
